    ...
    <div data-role="Header" className={`header-header ${props.rootClassName} `}>
      <nav className="header-nav">
        <div className="header-container">
          <Link to="/home_old" className="header-navlink">
            <img
              alt={props.image_alt}
              src={props.image_src}
        ...
        <header data-thq="thq-navbar" className="header-navbar-interactive">
          <img
            alt="logo"
            src="/Lazy Sats/lazysats_logo_orange-1500h.png"
          ...
          >
            ...
            >
              ...
              <span className="header-text5">Blog</span>
            </nav>
          </div>
            ...
            >
              ...
              >
                ...
                <button type="button" className="header-button1 button">
                  <span className="">Wallet Checker</span>
                </button>
...
Header.defaultProps = {
  button: 'Button',
  image_src: '/Lazy Sats/lazysats_logo_orange-1500h.png',
  image_alt: 'image',
  rootClassName: '',
  button1: 'Button',
}
