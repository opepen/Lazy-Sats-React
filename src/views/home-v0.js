...
const HomeV0 = (props) => {
  return (
    <div className="home-v0-container">
      <Helmet>
      ...
      <Header></Header>
      <div className="home-v0-hero">
        <div className="home-v0-hero1">
          <div className="home-v0-container1">
            <div className="home-v0-blog-post-card">
              <img
                alt="image"
                src="/Lazy Sats/collage%202-1400w.png"
                loading="eager"
                image_src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixid=Mnw5MTMyMXwwfDF8c2VhcmNofDd8fHBvcnRyYWl0fGVufDB8fHx8MTYyNjM3ODk3Mg&amp;ixlib=rb-1.2.1&amp;h=1000"
                className="home-v0-image"
              />
              <div className="home-v0-container2">
                <span className="home-v0-text">
                  <span>
                ...
                <div className="home-v0-container3">
                  <div className="home-v0-container4">
                    <a
                      href="https://discord.gg/EaNcmJky8H"
                      target="_blank"
                      rel="noreferrer noopener"
                      className="home-v0-link button"
                    >
                      Join the Discord
                    </a>
                  </div>
      ...
      <div className="home-v0-information">
        <div className="home-v0-information1">
          <div className="home-v0-container5">
            <CollaborationCard
      ...
      <div className="home-v0-social-bar">
        <Link to="/" className="home-v0-navlink">
          <svg viewBox="0 0 950.8571428571428 1024" className="home-v0-icon">
