...
const Lazy = (props) => {
  return (
    <div className="lazy-container">
      ...
      <Header></Header>
      <div className="lazy-hero">
        <div className="lazy-hero1">
          <div className="lazy-container1">
            <div className="lazy-blog-post-card">
              <img
                alt="image"
              ...
              />
              <div className="lazy-container2">
                <span className="lazy-text">
                  <span>
                ...
                <div className="lazy-container3">
                  <div className="lazy-container4">
                    <a
                      href="https://discord.gg/EaNcmJky8H"
                      target="_blank"
                      rel="noreferrer noopener"
                      className="lazy-link button"
                    >
                      Join the Discord
                    </a>
                  </div>
      ...
      <div className="lazy-information">
        <div className="lazy-information1">
          <div className="lazy-container5">
            <CollaborationCard
      ...
      <div className="lazy-social-bar">
        <Link to="/" className="lazy-navlink">
          <svg viewBox="0 0 950.8571428571428 1024" className="lazy-icon">
